...
class Solution:
    ...
    def dfs(self, image, x, y, newColor, originalColor, record):
    	...
    	image[x][y] = newColor
    	record.append((x, y))
    	self.dfs(image, x - 1, y, newColor, originalColor, record)
    	self.dfs(image, x + 1, y, newColor, originalColor, record)
    	self.dfs(image, x, y - 1, newColor, originalColor, record)
    	self.dfs(image, x, y + 1, newColor, originalColor, record)
    	return
